# Use pytorch_py3.8.8
import sys
sys.path.insert(1, '/home/tuomas/Python/Gradu/Pytorch code/JAE-ABAE_model2_pytorch/Model') 
...
d2 = 4
subdir = '200k/'
data_dir = f'/home/tuomas/Python/Gradu/data_processing/datasets/Amazon review data/Training_data/JAE_ABAE_2/{data_name[d1]}&{data_name[d2]}/{subdir}'
...
abae_dir = "/home/tuomas/Python/Gradu/Pytorch code/JAE-ABAE_model2_pytorch/Model/"
...
save_topics(topics_p1, data_conf['topic_path']+'topics_p1_2.txt')
save_topics(topics_p2, data_conf['topic_path']+'topics_p2_2.txt')
save_topics(topics_s12, data_conf['topic_path']+'topics_s12_2.txt')
